        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeightKgAtPrescription = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: true),
                    GeneralInstructions = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Prescriptions_AspNetUsers_FinalizedByUserId",
                        column: x => x.FinalizedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Prescriptions_AspNetUsers_VeterinarianUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Presentation = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionItems_ClinicId_PrescriptionId",
                table: "PrescriptionItems",
                columns: new[] { "ClinicId", "PrescriptionId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_ClinicId_ConsultationId",
                table: "Prescriptions",
                columns: new[] { "ClinicId", "ConsultationId" });

            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_ClinicId_PatientId_IssuedAtUtc",
                table: "Prescriptions",
                columns: new[] { "ClinicId", "PatientId", "IssuedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_VeterinarianUserId",
                table: "Prescriptions",
